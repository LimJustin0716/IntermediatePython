...
speakers = {"Sir Rafael": 54, "Ms. Joan": 33, "Miss Dana": 67}

name = speakers.keys()
print(name)

tryout_result = {"Carl": "passed", "Quentin": "failed", "John Y.": "passed", "Peter": "failed"
                 , "Ma T.": "passed", "Joseph": "passed", "Jone": "failed", "Jorge": "failed"
